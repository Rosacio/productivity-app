...
var _HourGuideCell = function (_a) {
    ...
    return (React.createElement(TouchableWithoutFeedback, __assign({ onLongPress: function () { return onLongPress(date.hour(hour).minute(0)); }, onPress: function () { return onPress(date.hour(hour).minute(0)); } }, calendarCellAccessibilityProps),
        React.createElement(View, { style: [
            ...
            ] }, Array.from({ length: timeslots }, function (_, index) { return (React.createElement(View, { key: index, style: [
                u['border-l'],
                u['border-b'],
                {
...
function _CalendarBody(_a) {
    ...
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement(ScrollView, __assign({ style: [
                ...
                style,
            ], ref: scrollView, scrollEventThrottle: 32 }, (Platform.OS !== 'web' ? panResponder.panHandlers : {}), { showsVerticalScrollIndicator: showVerticalScrollIndicator, scrollEnabled: scrollEnabled, nestedScrollEnabled: true, contentOffset: Platform.OS === 'ios' ? { x: 0, y: scrollOffsetMinutes } : { x: 0, y: 0 } }),
    ...
    var sortedEvents = React.useCallback(function (day) {
        if (!sortedMonthView) {
            ...
            var filteredEvents = events
                .filter(function (_a) {
                var start = _a.start, end = _a.end;
                return dayjs(end).isAfter(startOfWeek_1) && dayjs(start).isBefore(max_1);
            })
                .sort(function (a, b) {
            ...
            while (!tmpDay_1.isAfter(day)) {
                if (tmpDay_1 === startOfWeek_1) {
                    finalEvents_1 = __spreadArray([], filteredEvents, true);
                }
                finalEvents_1.forEach(function (event) {
                    if (dayjs(event.end).isBefore(tmpDay_1.startOf('day')) ||
                        dayjs(event.end).isSame(tmpDay_1.startOf('day'))) {
            ...
            finalEvents_1 = finalEvents_1.filter(function (e) {
                return !(dayjs(e.end).endOf('day').isSame(dayjs(day).startOf('day')) ||
        ...
        dateRange.map(function (date) {
            ...
            return (React.createElement(TouchableOpacity, __assign({ style: [u['flex-1'], u['pt-2']], onPress: function () { return _onPressHeader(date.toDate()); }, disabled: onPressDateHeader === undefined, key: date.toString() }, headerCellAccessibilityProps),
                ...
                showAllDayEventCell ? (React.createElement(View, { style: [
                    ...
                    return (React.createElement(TouchableOpacity, __assign({ style: [eventCellCss.style, primaryBg, u['mt-2'], getEventStyle(event)], key: index, onPress: function () { return _onPressEvent(event); } }, allDayEventCellAccessibilityProps),
                        React.createElement(Text, { style: {
...
function _CalendarContainer(_a) {
    ...
    var _25 = React__default.useState(function () { return dayjs(date); }), targetDate = _25[0], setTargetDate = _25[1];
    React__default.useEffect(function () {
        if (dateString) {
